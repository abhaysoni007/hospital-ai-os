...
import { intelligenceRoutes } from './modules/clinical-intelligence/intelligence.routes';
import { hospitalIntelligenceRoutes } from './modules/hospital-intelligence/hospital-intelligence.routes';
...
app.use('/api/v1/hospital-intelligence', hospitalIntelligenceRoutes);
