...
async function seed() {
  ...
  for (const d of DEPT_DEFS) {
    ...
    if (!row) {
      const [ins] = await db
        .insert(departments)
        .values({ code: d.code, name: d.name, status: 'active' })
        .returning();
      row = ins;
  ...
  type CritRuleDef = {
    ...
    unit: string;
    normalLow: string | null;
    normalHigh: string | null;
  ...
  const STAFF_DEFS: StaffDef[] = [
    {
      email: 'demo.physician@hospital.test',
      employeeId: 'DEMO-PHY-001',
      firstName: 'Rajan',
      lastName: 'Mehta',
      role: 'physician',
      deptCode: 'DEMO-CARD',
    ...
    {
      email: 'demo.physician2@hospital.test',
      employeeId: 'DEMO-PHY-002',
      firstName: 'Sarah',
      lastName: 'Williams',
      role: 'physician',
      deptCode: 'DEMO-IM',
    ...
    {
      email: 'demo.physician3@hospital.test',
      employeeId: 'DEMO-PHY-003',
      firstName: 'Ananya',
      lastName: 'Krishnan',
      role: 'physician',
      deptCode: 'DEMO-EM',
    ...
    {
      email: 'demo.physician4@hospital.test',
      employeeId: 'DEMO-PHY-004',
      firstName: 'Thomas',
      lastName: 'Obi',
      role: 'physician',
      deptCode: 'DEMO-PED',
    ...
    {
      email: 'demo.physician5@hospital.test',
      employeeId: 'DEMO-PHY-005',
      firstName: 'Elena',
      lastName: 'Vasquez',
      role: 'physician',
      deptCode: 'DEMO-CARD',
    ...
    {
      email: 'demo.nurse@hospital.test',
      employeeId: 'DEMO-NUR-001',
      firstName: 'Fatima',
      lastName: 'Al-Rashid',
      role: 'nurse',
      deptCode: 'DEMO-CARD',
    ...
    {
      email: 'demo.nurse2@hospital.test',
      employeeId: 'DEMO-NUR-002',
      firstName: 'Grace',
      lastName: 'Osei',
      role: 'nurse',
      deptCode: 'DEMO-IM',
    ...
    {
      email: 'demo.labtech@hospital.test',
      employeeId: 'DEMO-LAB-001',
      firstName: 'Viktor',
      lastName: 'Romanov',
      role: 'lab_technician',
      deptCode: 'DEMO-CARD',
    ...
    {
      email: 'demo.labtech2@hospital.test',
      employeeId: 'DEMO-LAB-002',
      firstName: 'Meera',
      lastName: 'Nair',
      role: 'lab_technician',
      deptCode: 'DEMO-LAB',
    ...
    {
      email: 'demo.receptionist@hospital.test',
      employeeId: 'DEMO-REC-001',
      firstName: 'Clara',
      lastName: 'Santos',
      role: 'receptionist',
      deptCode: 'DEMO-CARD',
    ...
    {
      email: 'demo.pharmacist@hospital.test',
      employeeId: 'DEMO-PHA-001',
      firstName: 'Arjun',
      lastName: 'Patel',
      role: 'pharmacist',
      deptCode: 'DEMO-CARD',
    ...
    {
      email: 'demo.security@hospital.test',
    ...
    {
      email: 'demo.admin@hospital.test',
      employeeId: 'DEMO-ADM-001',
      firstName: 'Linda',
      lastName: 'Torres',
      role: 'hospital_admin',
  ...
  const credLines = [
    ...
    '',
    '# ROLE             | EMAIL                                       | PASSWORD',
    ...credList.map((c) => `${c.role.padEnd(17)}| ${c.email.padEnd(44)}| ${c.pw}`),
    '',
    '# SCENARIO MAP',
  ...
  const ENC_DEFS: EncDef[] = [
    {
      ...
      deptId: cardId,
      type: 'opd',
      complaint: 'Severe fatigue pallor shortness of breath on exertion',
      target: 'active',
      apptKey: 'DEMO-APPT-001',
    },
    {
      key: 'DEMO-ENC-002',
      mrn: 'DEMO-2026-00002',
      ...
      deptId: imId,
      type: 'opd',
      complaint: 'Annual check-up mild hypertension follow-up',
      target: 'active',
      apptKey: 'DEMO-APPT-007',
    },
    {
      key: 'DEMO-ENC-003',
      mrn: 'DEMO-2026-00003',
      ...
      deptId: cardId,
      type: 'opd',
      complaint: 'Chest pain atypical rule out ACS',
      target: 'active',
    },
    {
      key: 'DEMO-ENC-004',
      ...
      deptId: cardId,
      type: 'opd',
      complaint: 'Palpitations intermittent 3 days',
      target: 'active',
    },
    {
      key: 'DEMO-ENC-005',
      ...
      deptId: imId,
      type: 'opd',
      complaint: 'Diabetes management review poor glycaemic control',
      target: 'active',
      apptKey: 'DEMO-APPT-008',
    },
    {
      key: 'DEMO-ENC-006',
      mrn: 'DEMO-2026-00007',
      ...
      deptId: cardId,
      type: 'opd',
      complaint: 'Dyspnoea on exertion',
      target: 'registered',
    },
    {
      key: 'DEMO-ENC-007',
      ...
      deptId: cardId,
      type: 'follow_up',
      complaint: 'Post-MI follow-up 3 months',
      target: 'registered',
    },
    {
      key: 'DEMO-ENC-008',
      ...
      deptId: cardId,
      type: 'opd',
      complaint: 'Hypertensive urgency evaluation',
      target: 'registered',
    },
    {
      key: 'DEMO-ENC-009',
      ...
      deptId: imId,
      type: 'opd',
      complaint: 'Fever cough 5 days suspected pneumonia',
      target: 'registered',
    },
    {
      key: 'DEMO-ENC-010',
      ...
      deptId: cardId,
      type: 'follow_up',
      complaint: 'Anticoagulation monitoring atrial fibrillation',
      target: 'registered',
    },
    {
      key: 'DEMO-ENC-011',
      ...
      deptId: emId,
      type: 'opd',
      complaint: 'Abdominal pain right lower quadrant',
      target: 'registered',
    },
    {
      key: 'DEMO-ENC-012',
      ...
      deptId: pedId,
      type: 'opd',
      complaint: 'Fever rash 7-year-old rule out viral exanthem',
      target: 'registered',
    },
    {
      key: 'DEMO-ENC-013',
      ...
      deptId: cardId,
      type: 'opd',
      complaint: 'Newly diagnosed hypertension initiating therapy',
      target: 'registered',
    },
    {
      key: 'DEMO-ENC-014',
      ...
      deptId: imId,
      type: 'follow_up',
      complaint: 'Chronic kidney disease monitoring eGFR trending down',
      target: 'registered',
    },
  ];
  ...
  const hasDraftSoap = await db.query.clinicalRecords.findFirst({
    where: and(
      eq(clinicalRecords.encounterId, enc004),
      eq(clinicalRecords.recordType, 'soap'),
      ...
      enc004,
      {
        ...
        content: {
          sections: [
            {
              heading: 'subjective',
              content: 'Palpitations 3 days. No syncope. Increased caffeine recently.',
            },
            {
              heading: 'objective',
              content: 'HR 88 irregular, BP 128/82, SpO2 98%. Lungs clear. No murmurs.',
            },
            {
              heading: 'assessment',
              content: 'Palpitations under investigation. Caffeine-induced vs paroxysmal AF.',
            },
            {
              heading: 'plan',
              content: 'Order ECG and Holter monitor. Reduce caffeine. Return in 1 week.',
            },
          ],
        },
      },
  ...
  if (!hasDraftProgress) {
    await clinicalService.createClinicalRecord(
      enc004,
      {
        ...
        content: {
          narrative: 'Awaiting ECG results. Patient for observation. Symptoms mild and stable.',
        },
      },
      phy1Id,
      crypto.randomUUID(),
  ...
  const hasSignedSoap = await db.query.clinicalRecords.findFirst({
    where: and(
      eq(clinicalRecords.encounterId, enc003),
      eq(clinicalRecords.recordType, 'soap'),
      eq(clinicalRecords.status, 'signed'),
    ),
  });
  if (!hasSignedSoap) {
    const draft = await clinicalService.createClinicalRecord(
      enc003,
      {
        recordType: 'soap',
        content: {
          sections: [
            {
              heading: 'subjective',
              content: 'Chest pain atypical 2 days. Left arm radiation. Diaphoresis.',
            },
            {
              heading: 'objective',
              content: 'HR 94, BP 145/90. ECG no ST-elevation. Troponin I pending.',
            },
            { heading: 'assessment', content: 'Possible NSTEMI. Cardiology workup initiated.' },
            {
              heading: 'plan',
              content:
                'Admit for observation. Serial troponins. Aspirin 325mg stat. Heparin infusion.',
            },
          ],
        },
      },
    ...
    console.log(
      '  + DEMO-SIGNED-001 SOAP (create + sign via real clinicalService.signClinicalRecord)',
    );
  } else {
    console.log('  . DEMO-SIGNED-001 SOAP signed');
  }
  ...
  const hasVitals = await db.query.clinicalRecords.findFirst({
    where: and(
      eq(clinicalRecords.encounterId, enc001),
      eq(clinicalRecords.recordType, 'vital_signs'),
    ),
  });
  if (!hasVitals) {
    await clinicalService.createClinicalRecord(
  ...
  type OrdDef = {
    ...
    enterResult?: {
      labId: string;
      labDept: string;
      values: Array<{ parameterName: string; value: number; unit: string }>;
    };
  };
  ...
  const ORD_DEFS: OrdDef[] = [
    // DEMO-CRITICAL-001: CBC stat — Hgb 5.8 g/dL (CRITICAL LOW < 7.0) — MUST use real enterResult
    {
      ...
      priority: 'stat',
      indication: 'Severe anaemia suspected. Fatigue pallor tachycardia.',
      deptId: cardId,
      collectWith: lab1Id,
      enterResult: {
        labId: lab1Id,
        labDept: cardId,
        values: [
          { parameterName: 'Hemoglobin', value: 5.8, unit: 'g/dL' },
          { parameterName: 'WBC', value: 6.2, unit: '10^3/uL' },
          { parameterName: 'Platelets', value: 210, unit: '10^3/uL' },
        ],
      },
    },
    ...
    // DEMO-NORMAL-001: BMP routine — all normal
    {
      ...
      encKey: 'DEMO-ENC-002',
      docId: phy2Id,
      patMrn: 'DEMO-2026-00002',
      testCode: 'BMP',
      testName: 'Basic Metabolic Panel',
      priority: 'routine',
      indication: 'Hypertension monitoring electrolytes renal function.',
      deptId: imId,
      collectWith: lab2Id,
      enterResult: {
        labId: lab2Id,
        ...
        values: [
          ...
          { parameterName: 'Potassium', value: 4.1, unit: 'mEq/L' },
          { parameterName: 'Glucose', value: 92.0, unit: 'mg/dL' },
          { parameterName: 'Creatinine', value: 1.0, unit: 'mg/dL' },
        ],
      },
    },
    // Troponin urgent — ordered only
    {
      ...
      encKey: 'DEMO-ENC-003',
      docId: phy1Id,
      patMrn: 'DEMO-2026-00003',
      testCode: 'TROP',
      testName: 'Troponin I',
      priority: 'urgent',
      indication: 'Possible NSTEMI serial troponin required.',
      deptId: cardId,
    },
    // BMP routine — ordered
    {
      ...
      encKey: 'DEMO-ENC-005',
      docId: phy2Id,
      patMrn: 'DEMO-2026-00006',
      testCode: 'BMP',
      testName: 'Basic Metabolic Panel',
      priority: 'routine',
      indication: 'Diabetes follow-up HbA1c renal panel.',
      deptId: imId,
    },
    // LFT routine — ordered
    {
      ...
      priority: 'routine',
      indication: 'Baseline liver function.',
      deptId: cardId,
    },
    // CBC routine — ordered
    {
      ...
      testName: 'Complete Blood Count',
      priority: 'routine',
      indication: 'Baseline haematology.',
      deptId: cardId,
    },
    // CBC urgent pneumonia — collected
    {
      ...
      encKey: 'DEMO-ENC-009',
      docId: phy2Id,
      patMrn: 'DEMO-2026-00011',
      testCode: 'CBC',
      testName: 'Complete Blood Count',
      priority: 'urgent',
      indication: 'Suspected CAP WBC count required.',
      deptId: imId,
      collectWith: lab2Id,
    },
    // BMP CKD
    {
      ...
      encKey: 'DEMO-ENC-014',
      docId: phy2Id,
      patMrn: 'DEMO-2026-00016',
      testCode: 'BMP',
      testName: 'Basic Metabolic Panel',
      priority: 'routine',
      indication: 'CKD monitoring track creatinine.',
      deptId: imId,
    },
    // CBC stat EM (appendicitis)
    {
      ...
      encKey: 'DEMO-ENC-011',
      docId: phy3Id,
      patMrn: 'DEMO-2026-00013',
      testCode: 'CBC',
      testName: 'Complete Blood Count',
      priority: 'stat',
      indication: 'Acute abdominal pain rule out appendicitis.',
      deptId: emId,
    },
    // LFT routine IM
    {
      ...
      testName: 'Liver Function Tests',
      priority: 'routine',
      indication: 'Liver function monitoring medication review.',
      deptId: imId,
    },
  ];
  ...
  for (const o of ORD_DEFS) {
    ...
    if (!existing) {
      const [ins] = await db
        ...
        .values({
          ...
          testName: o.testName,
          priority: o.priority,
          clinicalIndication: o.indication,
          status: 'ordered',
        })
        .returning();
      ordId = ins.id;
    ...
    if (o.collectWith) {
      const cur = await db.query.diagnosticOrders.findFirst({
        where: eq(diagnosticOrders.id, ordId),
      });
      if (cur?.status === 'ordered') {
        await diagSvc.collectSample(ordId, o.collectWith, crypto.randomUUID(), {
          role: 'lab_technician',
    ...
    if (o.enterResult) {
      ...
      const resultExists = await db.query.diagnosticResults.findFirst({
        where: eq(diagnosticResults.orderId, ordId),
      });
      if (!resultExists && cur?.status === 'sample_collected') {
        ...
        if (o.key === 'DEMO-ORDER-001') {
          ...
          if (notif) {
            console.log(
              `    -> CRITICAL notification confirmed (M10 workflow, id=${notif.id.slice(0, 8)}...)`,
            );
            console.log(
              `       provenance: DiagnosticsService.enterResult -> evaluateCriticalValues -> notification insert`,
            );
          } else {
            console.warn(`    -> WARNING: critical notification not found for DEMO-CRITICAL-001`);
            console.warn(
              `       Check that CBC:Hemoglobin rule with criticalLow=7.0 exists and is active`,
            );
          }
        }
  ...
  const critResult = await db.query.diagnosticResults.findFirst({
    where: eq(diagnosticResults.orderId, ordMap.get('DEMO-ORDER-001')!),
  });
  chk('DEMO-ORDER-001 result exists', !!critResult);
  chk(
    'DEMO-ORDER-001 isCritical=true',
    critResult?.isCritical === true,
    `got ${critResult?.isCritical}`,
  );
  chk(
    'DEMO-ORDER-001 status=critical_flagged',
    critResult?.status === 'critical_flagged',
    `got ${critResult?.status}`,
  );
  ...
  chk(
    'Critical notification status=dispatched',
    critNotif?.status === 'dispatched',
    `got ${critNotif?.status}`,
  );

  // Orphan checks
  const orphEnc = await db.execute(
    sql`SELECT count(*)::int AS n FROM encounters e WHERE NOT EXISTS (SELECT 1 FROM patients p WHERE p.id = e.patient_id)`,
  );
  chk('No orphan encounters', (orphEnc as unknown as Array<{ n: number }>)[0]?.n === 0);
  const orphOrd = await db.execute(
    sql`SELECT count(*)::int AS n FROM diagnostic_orders o WHERE NOT EXISTS (SELECT 1 FROM encounters e WHERE e.id = o.encounter_id)`,
  );
  chk('No orphan diagnostic orders', (orphOrd as unknown as Array<{ n: number }>)[0]?.n === 0);
  const orphRes = await db.execute(
    sql`SELECT count(*)::int AS n FROM diagnostic_results r WHERE NOT EXISTS (SELECT 1 FROM diagnostic_orders o WHERE o.id = r.order_id)`,
  );
  ...
  if (critResult?.criticalRuleId) {
    const rule = await db.query.criticalValueRules.findFirst({
      where: eq(criticalValueRules.id, critResult.criticalRuleId),
    });
    chk(
      'Critical result references valid rule',
      !!rule,
      `${rule?.testCode}:${rule?.parameterName}`,
    );
  }
